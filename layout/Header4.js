                    ...
                    <div className="container clearfix">
                        ...
                        <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`} id="navbarNavDropdown">
                            ...
                            <ul className="nav navbar-nav navbar">	
                                    ...
                                    <ul className="sub-menu">
                                        <li className={`${open === "aboutsub1" ? "open" : ""}`}><a  onClick={() => setOpen("aboutsub1")}>About Us <i className="fa fa-angle-right"></i></a>
                                            <ul className="sub-menu">
                                                ...
                                                <Link href="/about-us-2"><a>About Us 2</a></Link>
                                                <Link href="/about-us-3"><a>About Us 3</a></Link>
                                            </ul>
                                        </li>
                                        <li className={`${open === "aboutsub2" ? "open" : ""}`}><a  onClick={() => setOpen("aboutsub2")}>Faq <i className="fa fa-angle-right"></i></a>
                                            <ul className="sub-menu">
                                                ...
                                                <Link href="/faq-2"><a>Faq 2</a></Link>
                                                <Link href="/faq-3"><a>Faq 3</a></Link>
                                            </ul>
                                        </li>
                                        <li><Link href="#"><a>Pricing Table <i className="fa fa-angle-right"></i></a></Link>
                                            <ul className="sub-menu">
                                        ...
                                        <li><Link href="#"><a>Team <i className="fa fa-angle-right"></i></a></Link>
                                            <ul className="sub-menu">
                                ...
                                <li><Link href="#"><a><span>Services</span><i className="fa fa-chevron-down"></i></a></Link>
                                    <ul className="sub-menu">
                                        <li><Link href="#"><a>Services <i className="fa fa-angle-right"></i></a></Link>
                                            <ul className="sub-menu">
                                        ...
                                        <li><Link href="#"><a>Services Details <i className="fa fa-angle-right"></i></a></Link>
                                            <ul className="sub-menu">
                                ...
                                <li><Link href="#"><a><span>Blog</span><i className="fa fa-chevron-down"></i></a></Link>
                                    <ul className="sub-menu">
                                        ...
                                        <li><Link href="#"><a>Blog Details <i className="fa fa-angle-right"></i></a></Link>
                                            <ul className="sub-menu">
                                ...
                                <li><Link href="#"><a><span>Contact Us</span><i className="fa fa-chevron-down"></i></a></Link>
                                    <ul className="sub-menu">
