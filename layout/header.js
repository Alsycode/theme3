...
function Header() {
    ...
    return (
      <>
        {/* <!-- Header --> */}
        <header className="site-header header-transparent text-black mo-left d-none">
            {/* <!-- Main Header --> */}
                            ...
                            <ul className="nav navbar-nav navbar">	
                                ...
                                <li className={`${open === "about" ? "open" : ""}`}><a  onClick={() => setOpen("about")}><span>Pages</span><i className="fa fa-chevron-down"></i></a>
                                    <ul className="sub-menu">
                                        ...
                                        <li className={`${open === "team" ? "open" : ""}`}><a onClick={() => setOpen("team")}>Team <i className="fa fa-angle-right"></i></a>
                                            <ul className="sub-menu">
